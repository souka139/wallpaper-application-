...
public class QuotesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Quotes wallpapers");

        reference= FirebaseDatabase.getInstance().getReference().child("quotes_imgs");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rcvMain.setLayoutManager(new GridLayoutManager(QuotesActivity.this,3));
                RecyclerViewAdapter_quotes recyclerViewAdapter=new RecyclerViewAdapter_quotes(QuotesActivity.this,imgArrayList);
