...
public class kawaiiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Cute wallpapers");

        reference= FirebaseDatabase.getInstance().getReference().child("kawaii_imgs");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rcvMain.setLayoutManager(new GridLayoutManager(kawaiiActivity.this,3));
                RecyclerViewAdapter_kawaii recyclerViewAdapter=new RecyclerViewAdapter_kawaii(kawaiiActivity.this,imgArrayList);
