...
public class PatternsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Patterns wallpapers");

        reference= FirebaseDatabase.getInstance().getReference().child("patterns_imgs");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rcvMain.setLayoutManager(new GridLayoutManager(PatternsActivity.this,3));
                RecyclerViewAdapter_patterns recyclerViewAdapter=new RecyclerViewAdapter_patterns(PatternsActivity.this,imgArrayList);
