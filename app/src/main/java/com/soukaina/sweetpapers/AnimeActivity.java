...
public class AnimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Anime wallpapers");

        reference= FirebaseDatabase.getInstance().getReference().child("anime_imgs");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                rcvMain.setLayoutManager(new GridLayoutManager(AnimeActivity.this,3));
                RecyclerViewAdapter_anime recyclerViewAdapter_anime=new RecyclerViewAdapter_anime(AnimeActivity.this,imgArrayList);
                rcvMain.setAdapter(recyclerViewAdapter_anime);
            }
